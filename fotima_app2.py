...
MUSIC_YOUTUBE_ID: str = "V1Pl8CzNzCw"
...
def render_music_player() -> None:
    ...
    st.markdown(
        ...
        ">
            ...
            <div style="flex:1;">
                <p style="margin:0;font-weight:700;color:#000000;font-size:0.88rem;">
                    Now Playing: wildflower
                </p>
                <p style="margin:0;color:#000000;font-size:0.78rem;">Billie Eilish</p>
            </div>
            <span style="font-size:0.72rem;color:#000000;font-weight:700;">♫ PLAYING</span>
        </div>
        <iframe
            width="100%" height="80"
...
def apply_styles() -> None:
    st.markdown(
        ...
        .card {
            ...
            box-shadow: 0 8px 30px rgba(100,50,180,0.12);
            border: 1.5px solid rgba(180,140,230,0.40);
        ...
        .section-tag {
            display: inline-block;
            background: rgba(176, 127, 212, 0.22);
            color: #000000 !important;
        ...
        div[data-testid="stRadio"] div[role="radiogroup"] label {
            background: rgba(243,234,255,0.75);
        ...
        div[data-testid="stRadio"] div[role="radiogroup"] label:hover {
            background: rgba(200,168,240,0.45);
        }
        ...
        div[data-testid="stExpander"] {
            ...
            border: 1.5px solid rgba(180,140,230,0.35) !important;
            overflow: hidden;
        }
    ...
    st.markdown(
        ...
        <div class="card">
            ...
            <table style="width:100%;border-collapse:collapse;margin-top:0.8rem;">
                <tr>
                    <td style="padding:0.35rem 0.5rem;color:#000000;">📋 Questions</td>
                    <td style="padding:0.35rem 0.5rem;font-weight:700;color:#000000;">20 questions across 5 sections</td>
                </tr>
                <tr style="background:rgba(180,130,230,0.07);">
                    <td style="padding:0.35rem 0.5rem;color:#000000;">⏱️ Time</td>
                    <td style="padding:0.35rem 0.5rem;font-weight:700;color:#000000;">~{ESTIMATED_TIME:.0f} minutes</td>
                </tr>
                <tr>
                    <td style="padding:0.35rem 0.5rem;color:#000000;">🎯 Purpose</td>
                    <td style="padding:0.35rem 0.5rem;font-weight:700;color:#000000;">Evaluate evening habits & study readiness</td>
                </tr>
                <tr style="background:rgba(180,130,230,0.07);">
                    <td style="padding:0.35rem 0.5rem;color:#000000;">🎵 Music</td>
                    <td style="padding:0.35rem 0.5rem;font-weight:700;color:#000000;">Billie Eilish — wildflower plays during the survey</td>
                </tr>
                <tr>
                    <td style="padding:0.35rem 0.5rem;color:#000000;">🔒 Privacy</td>
                    <td style="padding:0.35rem 0.5rem;font-weight:700;color:#000000;">All responses are strictly confidential</td>
                </tr>
            </table>
        </div>
        """,
...
def page_results() -> None:
    ...
    st.markdown(
        ...
        <div class="card" style="text-align:center;background:linear-gradient(135deg,rgba(240,225,255,0.9),rgba(220,196,252,0.9));">
            <p style="color:#000000;font-weight:600;margin-bottom:0.4rem;">Total Score</p>
            <span class="score-chip">{score} / {MAX_SCORE}</span>
            <h2 style="margin-top:1rem;color:#000000;">{state.get('label','')}</h2>
            <p style="color:#000000;">{state.get('description','')}</p>
        </div>
        """,
        unsafe_allow_html=True,
    )
